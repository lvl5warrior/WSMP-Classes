...
public final class LevelService {
    ...
    private final XpBarManager xpBarManager;

    public LevelService(ClassConfig config, XpBarManager xpBarManager) {
        this.config = config;
        this.xpBarManager = xpBarManager;
    }
    ...
    public int grantXp(Player player, PlayerClassData data, double amount) {
        ...
        xpBarManager.showXpGain(player, data);
        return levelAfter;
    }
