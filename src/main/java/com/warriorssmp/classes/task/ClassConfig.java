...
public final class ClassConfig {
    ...
    public void load() {
        ...
        if (settings != null) {
            ...
            fireballBaseDamage = settings.getDouble("fireball-base-damage", 5.0);
            ...
            lightningBaseDamage = settings.getDouble("lightning-base-damage", 8.0);
            lightningCooldownMillis = settings.getLong("lightning-cooldown-seconds", 8) * 1000L;
            iceballBonusDamage = settings.getDouble("iceball-bonus-damage", 2.0);
            ...
            powerShotBaseDamage = settings.getDouble("power-shot-base-damage", 7.0);
        ...
        if (nodesSection != null) {
            for (String id : nodesSection.getKeys(false)) {
                ...
                nodes.put(id, new SkillNode(
                        ...
                        translateColors(ns.getString("description", "")),
                        ns.getInt("cost", 1),
                        prereqs,
