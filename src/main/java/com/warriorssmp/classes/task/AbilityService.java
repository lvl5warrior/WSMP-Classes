...
public final class AbilityService {
    ...
    /** Right-click a bow (while sneaking) to fire a real volley — one arrow
     *  of each vanilla arrow type at once (Arrow, Spectral Arrow, and two
     *  Tipped Arrows with different real potion effects), consuming one
     *  arrow of any type from the player's inventory as its cost. Always
     *  available to any Archer from level 1, upgraded by the tree the same
     *  way Fireball/Whirlwind are. */
