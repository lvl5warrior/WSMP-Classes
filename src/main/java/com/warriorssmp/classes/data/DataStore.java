...
public final class DataStore {
    ...
    private PlayerClassData load(UUID uuid) {
        ...
        data.iceballReadyAt = yml.getLong("iceball-ready-at", 0);
        data.chargeReadyAt = yml.getLong("charge-ready-at", 0);
    ...
    public void save(PlayerClassData data) {
        ...
        yml.set("iceball-ready-at", data.iceballReadyAt);
        yml.set("charge-ready-at", data.chargeReadyAt);
